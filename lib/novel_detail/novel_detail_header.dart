...
class NovelDetailHeader extends StatelessWidget{
         ...
         children: <Widget>[
           ...
           Expanded(
               child: Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: <Widget>[
                   Text(novel.name,style: TextStyle(
                   ...
                   Expanded(child: Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                     children: <Widget>[
                       Text(novel.author,style: TextStyle(
                           fontSize: fixedFontSize(18),
                           color: Colors.white,
                           fontWeight: FontWeight.bold
                       ),
  ...
  Widget buildScore(){
    List<Widget> children =[Text('评分：${novel.score}',style: TextStyle(fontSize: fixedFontSize(14),color: Color(0xfff8e71c) ))];
